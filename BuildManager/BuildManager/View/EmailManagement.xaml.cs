...
{
    /// <summary>
    /// Interaction logic for EmailManagement.xaml
    /// </summary>
    public partial class EmailManagement : DbTableModifyBase
    {
        EmailManagementViewModel vm = new EmailManagementViewModel("Email");
        public EmailManagement(MainWindow window ) :base()
        {
            this.mainWindow = window;
            base.viewModel = vm;
            this.ColumnNameForEdit = "EmailAccount";
            InitializeComponent();
        ...
        protected void SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                this.vm.CurrentItemToEdit = e.AddedItems[0] as Email;
            }
            else
            {
